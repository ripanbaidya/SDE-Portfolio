              ...
              <div className="container">
                ...
                <motion.div className="services-box" whileInView={fade} initial={{opacity: 0}}>
                    ...
                    <div className="services-card">
                        ...
                        <p className='services-desc'>I use modern technologies to develop robust and scalable server-side applications for web and mobile applications.</p>
                    </div>
                    <div className="services-card">
                        <IoColorWandOutline className='services-icon' />
                        <p className='services-title'>Microservice Development</p>
                        <p className='services-desc'>I use microservice architecture to develop scalable and maintainable applications that can handle complex business requirements.</p>
                    </div>
                </motion.div>
              </div>
          </div>
